...
- 安装一个新的 skill
- 把 skill 复制到 `%USERPROFILE%\.claude\skills`
- 更新已有 skill
- 删除 skill
- 盘点当前已安装的 skill
...
1. 先扫描 `%USERPROFILE%\.claude\skills`。
2. 读取 `%USERPROFILE%\.claude\skills\SKILLS_REGISTRY.csv`。
...
- `%USERPROFILE%\.claude\skills\skill-registry\skill_registry_gui.py`
